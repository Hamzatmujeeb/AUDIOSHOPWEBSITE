...
<template>
 ...
 <section>
    <div class="XXX9-wrapper">
      <div class="XXX9-wrapper-container">
        <div class="XXX9-container-column-one">
          <img src="@/assets/images/mini-speaker.png" alt="mini-speaker" />
          <div class="shadwow-circle"></div>
        </div>
        <div class="XXX9-container-column-two">
          <h1 class="XXX9-header">XX99 Mark I<br>Headphones</h1>
          <p class="XXX9-text">Stream high quality sound wirelessly with minimal to no loss. 
          The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.</p>
  ...
  <div class="feature-wrapper">
      <div class="features-wrapper-container">
        <div class="features-container-column-one">
          ...
          <p class="features-text">Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response
             rate and excellent high frequencies that lower tiered bookshelf speakers 
            cannot provide. The woofers are made from aluminum that produces a unique and clear sound. XLR inputs allow you to connect to a mixer for more advanced usage.
             <br><br><br>
             The ZX7 speaker is the perfect blend of stylish design and high performance. It houses an encased
              MDF wooden enclosure which minimises acoustic resonance. Dual connectivity allows pairing through bluetooth or traditional optical and RCA input. Switch input 
             sources and control volume at your finger tips with the included wireless remote. This versatile speaker is equipped to deliver an authentic listening experience.
        </p>
        </div>
  ...
  <section>
    ...
    <div class="grid-item">
      <img src="@/assets/images/gallery11.png" alt="gallery11"  class="column-images-one" />
      <img src="@/assets/images/gallery12.png" alt="gallery-1" class="column-images-one second-image" />
    </div>
    <div class="grid-item2">
      <img src="@/assets/images/gallery13.png" alt="gallery2" class="column-images-two"/>
    </div>
  </div>
  </section>
    ...
    <div class="main-wrapper-container">
      <div class="main-column">
        <div class="images-background">
          <img src="@/assets/images/product-speaker.png" alt="headphone" />
        </div>
...
.XXX9-wrapper-container {
  display: grid;
  grid-template-columns: auto auto; /* Two columns, adjust as needed */
  gap: 3rem; /* Adjust the gap between columns */
  align-items: center;
  margin-left: 2.3rem;
}

.XXX9-container-column-one  {
...
.XXX9-container-column-one .shadwow-circle{
    width: 16.375rem;
    height: 3.5rem;
    flex-shrink: 0;
...
.XXX9-container-column-two .XXX9-text{
  width: 27.8125rem;
  margin-top: 2rem;
  color: #000;
  font-family: Manrope;
...
.XXX9-container-column-two .price{
  color: #000;
  margin-top: 2rem;
  font-family: Manrope;
  font-size: 1.125rem;
...
.XXX9-buttons {
    display: flex;
    gap: 10px; /* Adjust the gap between the buttons and the "1" text */
    margin-top: 2.94rem;
  }

  .XXX9-buttons .number-button {
    width: 7.5rem;
    height: 3rem;
    color: #000; /* Black color for the button text */
    background: #F1F1F1; /* Background color for the button */
    font-family: Manrope;
    font-size: 1rem;
    font-style: normal;
    font-weight: 700;
...
.XXX9-buttons .number-button .one {
    color: #000; /* Black color for "1" text */
    text-align: center;
    font-family: Manrope;
    font-size: 0.8125rem;
    font-style: normal;
...
.features-wrapper-container {
  display: grid;
  grid-template-columns: auto auto; /* Two columns, adjust as needed */
  gap: 22rem; /* Adjust the gap between columns */
  align-items: center;
  width: 77.375rem;
  margin: 0 2.45rem;
}
...
.features-wrapper-container .features-container-column-one {
  background:none;
  width: 27.8125rem;
  height: 24.0625rem;
  margin-left: 12rem;
...
.features-container-column-two{
  background:none;
  width: 27.8125rem;
  height: 24.0625rem;
  margin-right: -6rem;
}
 .features-in-box-text{
  width: 27.8125rem;
  color: #000;
  font-family: Manrope;
  font-size: 2rem;
...
.features-container-column-one .features-text{
  margin:2rem 0 0 0;
  width: 39.6875rem;
  color: #000;
  font-family: Manrope;
...
.gallery-container {
  ...
  width: 70rem;
  align-items: center;
  margin: 0 14rem; /* Center the gallery container */
}

.grid-item {
  width: auto;
  height: 37rem;
  gap: 2rem; /* Reduce the gap between grid items */
}
...
.main-contact-container-column .column-header-paragraph{
    color: #000;
    width: 27.8125rem;
    font-size: 0.9375rem;
    font-style: normal;
...
.main-contact-container-column img{
    width: 33.75rem;
    height: 36.75rem;
    border-radius: 0.5rem;
    flex-shrink: 0;
