 ...
 <section>
    <div class="IIHeadphones-container">
      ...
      <div class="IIHeadphones-column-2">
        ...
        <P>The new XX99 Mark II headphones is the pinnacle of pristine<br>audio. 
            It redefines your premium headphone experience by<br>reproducing the balanced depth and precision of studio-quality<br>sound</P>
    ...
    <div class="IIHeadphones-container">
      <div class="IIHeadphones-column-2">
        ...
        <P>As the gold standard for headphones, the classic XX99 Mark<br> I offers detailed and 
            accurate audio reproduction for <br>audiophiles, mixing engineers, and music aficionados 
            alike in<br> studios and on the go.</P>
        <button class="see-product-button">See Product</button>
      </div>
      <div class="IIHeadphones-column-1">
    ...
    <div class="IIHeadphones-container">
      ...
      <div class="IIHeadphones-column-2">
        ...
        <P>Enjoy your audio almost anywhere and customize it to your<br> specific 
            tastes with the XX59 headphones. The stylish yet<br> durable versatile
             wireless headset is a brilliant companion at<br> home or on the move.</P>
        <button class="see-product-button">See Product</button>
      </div>
    </div>
 </section>
...
/*Headphone styles */
.IIHeadphones-container {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  width: 69.375rem;
  margin: 10.75rem 10rem 0 16.75rem; /* top right bottom left */
  gap: 13.5rem;
}

.IIHeadphones-container .IIHeadphones-column-1{
    background: #F1F1F1;
    width: 33.75rem;
    height: 35rem;
    margin:0;
...
.IIHeadphones-container .IIHeadphones-column-1 img{
    width: 21.82738rem;
    height: 24.125rem;
    margin-left: auto;
    margin-right: auto;
...
.IIHeadphones-container .IIHeadphones-column-2{
    width: 27.8125rem;
    height: 21.4375rem;
    flex-shrink: 0;
}

 .IIHeadphones-column-2 h2{
    margin-top: 5.81rem;
    color: #D87D4A;
    font-family: Manrope;
    font-size: 0.875rem;
...
.IIHeadphones-column-2 .see-product-button {
    background: #D87D4A;
    width: 10rem;
    height: 3rem;
    border: none;
